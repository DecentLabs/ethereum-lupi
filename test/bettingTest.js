...
contract("Lupi betting tests", accounts => {
    ...
    it('should be possible to play a round with 1 bet', () => {
        var testParams = new bettingHelper.TestParams( { accounts: accounts, testCaseName: "1b win",
    ...
    it('should be possible to play a round with 4 bets and winner', () => {
        var testParams = new bettingHelper.TestParams( { accounts: accounts, testCaseName: "4b win",
    ...
    it('should be possible to play a round with 4 bets and no winner', () => {
        var testParams = new bettingHelper.TestParams( { accounts: accounts, testCaseName: "4b no win",
    ...
    it('should be possible to play a round with 10 bets and winner', () => {
    ...
    it('should be possible to play a round with 10 bets and no winner', () => {
